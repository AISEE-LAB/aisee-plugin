...
|---|---|---|---|---|
| SRS | aisee/docs/requirements/auth-srs.md | auth:FR-001 | confirmed | Passwordless login requirement |
| UI Content | aisee/docs/ui-content/auth-ui.md | auth:PAGE-001, auth:FLOW-001, auth:STATE-001 | confirmed | Login page content and states |
| Architecture | aisee/docs/architecture/auth-architecture.md | auth:ARCH-001, auth:DEC-001 | confirmed | Token storage and session boundary |
...
| TEST | auth:TEST-001 | Contract and behavior tests | This change | produce | tasks.md |

## Artifact Applicability

| Artifact | Required | IDs | Reason | Handoff |
|---|---|---|---|---|
| change-context.md | yes | auth:ARCH-001, auth:DEC-001 | Session and token decisions affect implementation | service-contract.md, data-model.md |
| ui-contract.md | yes | auth:PAGE-001, auth:FLOW-001, auth:STATE-001 | Login page content and states change | service-contract.md |
| service-contract.md | yes | auth:API-001 | Frontend and backend are separate projects | tasks.md |
| data-model.md | yes | auth:DATA-001 | Verification tokens require persistence | service-contract.md, tasks.md |

## Contract Ownership / Sync

| Key | Value | Status | Notes |
|---|---|---|---|
| contract_owner | backend | confirmed | Backend owns canonical API behavior |
...
|---|---|---|---|
| docs/verification/add-passwordless-login-openspec-validate.md | auth:TEST-001 | expected | OpenSpec validation evidence |
| docs/verification/add-passwordless-login-tests.md | auth:TEST-001 | expected | Automated tests evidence |
| docs/reviews/add-passwordless-login-code-review.md | auth:TEST-001 | expected | Code review evidence |
