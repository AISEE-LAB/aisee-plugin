...
```text
aisee/docs/design-assets/specs/style-spec-001.md
aisee/docs/design-assets/specs/style-spec-001.json
```
...
```json
{
  ...
  "source": {
    ...
    "paths": ["aisee/docs/design-assets/references/reference-001.png"],
    "notes": ""
  },
  "visualPositioning": {
    "keywords": [],
