...
> 当前状态：early alpha / pre-release。仓库支持源码安装、plugin export、版本一致性检查和发布 smoke test；PyPI/pipx 公开发布与 1.0 兼容冻结仍在完善中。
...
- 扩展跨仓库契约协作示例。
- 稳定 team knowledge 远程安装、同步、promote-batch、生命周期管理和可选 MCP 包装。
