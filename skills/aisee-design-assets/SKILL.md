...
判断维度：平台（mobile / mini-program / h5 / pc / desktop / multi）、任务模式（reference / style-draft / assets / edit / figma-brief / dev-brief / auto）、输出格式（md / json / both）和输出目录。默认输出到目标项目的 `docs/design-assets/`。
