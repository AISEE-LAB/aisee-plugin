...
| 模板 | 文件 | 使用时机 |
|------|------|----------|
| Core | `tech-context-template-core.md` | 所有技术域都必须读取 |
| Software | `tech-context-template-software.md` | software / web / backend / cli / job / integration / data |
| Embedded | `tech-context-template-embedded.md` | hardware / embedded / firmware / rtos / driver |
| Artifact Hints | `tech-context-template-artifact-hints.md` | 所有技术域都必须读取 |
...
- `tech-context-template-core.md`
- `tech-context-template-software.md`
- `tech-context-template-artifact-hints.md`
...
- `tech-context-template-core.md`
- `tech-context-template-embedded.md`
- `tech-context-template-artifact-hints.md`
- `../references/writing-rules.md`
