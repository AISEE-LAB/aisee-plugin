...
find aisee/docs/design-assets -maxdepth 4 -type f 2>/dev/null | head -120
find aisee/docs/ui-content -maxdepth 4 -type f 2>/dev/null | head -80
find aisee/docs/architecture -maxdepth 3 -type f 2>/dev/null | head -40
