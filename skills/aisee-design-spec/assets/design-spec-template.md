...
- [ ] 已设置设计参数：visual_density、content_density、brand_expression、motion_level、component_customization
...
### 13.2 UI Content 到 Screen Pattern
...
### 14.1 给 aisee:design-assets
- {如何基于本规范生成参考图、素材或 visual brief}

### 14.2 给 aisee:change-plan
