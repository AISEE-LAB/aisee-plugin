...
- 存在 `aisee/docs/spec-migration/` 或历史 `aisee/docs/requirements/`
...
命名：`aisee/docs/requirements/<YYYY-MM-DD>-<requirement-slug>.md`

其中 `requirement-slug` 为功能名称前 5 个有意义词的 kebab-case。

```bash
mkdir -p aisee/docs/requirements
```
...
```bash
mkdir -p aisee/docs/requirements/<YYYY-MM-DD>-<slug>
```
...
> ✅ **SRS 已生成**：`aisee/docs/requirements/{filename}.md`
>
...
>
> - 主文档：`aisee/docs/requirements/{slug}/00-main.md`
> - 模块文档：
